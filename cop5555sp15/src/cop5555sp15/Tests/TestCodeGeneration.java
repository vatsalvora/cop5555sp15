...
public class TestCodeGeneration {
	...
	public void executeByteCode(String name, byte[] bytecode)
		...
		codelet.execute();
		Assert.assertEquals(solutions.get(testname.getMethodName()).trim(), baos.toString().trim());
	}
	...
	/**
	 * The following set of tests have to do with binary expressions. The type
	 * checker should ensure that both operand expressions are the same type,
	 * and set the type of the result expression appropriately. It is convenient
	 * to use the JVM type as the representation for types. It is also
	 * convenient for the visit method of Expressions (and subclasses) to return
	 * the type.
	 *
	 * Legal combinations of types and operators and the result types are given
	 * below. List and map types will be treated later.
	 *
	 * int (+ | - | * | /) int -> int string + string -> string int (== | != | <
	 * | <= | >= | >) int -> boolean string (== | !=) string -> boolean
	 *
	 */
	...
	@Test
	/*
	 * A more complicated program. This should pass if the previous steps have
	 * been done correctly.
	 * 
	 * output: x= 43 b= true
	 */
	...
	/**
	 * A few tests with type errors. These are expected to throw a
	 * TypeCheckException
	 */
	@Test
	/** This test is expected to throw a TypeCheckException
	...
	public TestCodeGeneration(){
		solutions.put("intNotEqual" , "\nfalse\ntrue\n");
		solutions.put("printStringLiteral" , "\ngo gators\n");
		solutions.put("printBooleanLiteral" , "\ntrue\n");
		solutions.put("booleanVariable" , "\nfalse\n");
		solutions.put("intBinaryOps2" , "\n4\n16\n-5\n2\n");
		solutions.put("stringConcat" , "\ngo***gators\n");
		solutions.put("intVariable" , "\n3\n");
		solutions.put("or" , "\nfalse\ntrue\ntrue\ntrue\n");
		solutions.put("and" , "\nfalse\nfalse\nfalse\ntrue\n");
		solutions.put("intBinaryOps" , "\n8\n14\n1\n3\n");
		solutions.put("stringRelational" , "\nfalse\ntrue\ntrue\nfalse\n");
		solutions.put("intEqual" , "\ntrue\nfalse\n");
		solutions.put("intRelational1" , "\nfalse\ntrue\nfalse\ntrue\n");
		solutions.put("intRelational2" , "\ntrue\nfalse\ntrue\nfalse\n");
		solutions.put("booleanRelational" , "\nfalse\ntrue\nfalse\ntrue\n");
		solutions.put("printIntLiteral" , "\n3\n");
		solutions.put("binaryExpressionFail3" , "\n");
		solutions.put("expressonsAndVars" , "\nx=\n43\nb=\ntrue\n");
	}
